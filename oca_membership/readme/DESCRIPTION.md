...
- **Target role \[TO FINISH: logique de facturation\]** New field
  *Target role* on Members form: it defines the role the member will
  receive when paying for its *next* membership. It should be updated by
  the association' secretary when members roles change, like on
  election, before the memberships are renewed.

...
class TestProject(common.TransactionCase):
    def setUp(self):
        ...
        self.project_2 = self.env["project.project"].create(
            {"name": "Project 2", "label_tasks": "Task 2"}
        )

        self.github_repository_1 = self.env["github.repository"].create(
            {
                "organization_id": self.ref("oca_psc_team.github_organization_1_demo"),
                "name": "Repository 1",
    ...
    def test_github_project_link(self):
        ...
        self.github_repository_2.write({"project_id": self.project_1.id})
        ...
        self.assertEqual(self.github_repository_1.project_id, self.project_2)

    def test_project_psc_category_link(self):
        self.psc_category_1.write({"project_ids": [(4, self.project_2.id)]})
        ...
        self.assertEqual(self.psc_category_2.project_ids, self.project_1)
...
class TestPscCategoryAccessRight(common.TransactionCase):
    ...
    def test_project_user_access_right(self):
        ...
        self.assertEqual(self.psc_category_1.name, "PSC Category 1")

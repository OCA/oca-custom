...
* Manually set *Grace date end* to a far date in the future. It will not be
  overriden by the automated mechanism.
...
A default domain helps filtering on all active members.
You may save this domain as favorite filter, and / or modify it.
